...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002906962851').split()]  # For Multiple Id Use One Space Between Each.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+_0Nd38EolntlNGZl')
