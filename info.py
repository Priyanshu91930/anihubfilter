...
PICS = (environ.get('PICS', 'https://graph.org/file/879291ee8fbc41feecfce-cc326a99bd3dd054cc.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1246987713').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1246987713').split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://priyanshusolanki62:AnihubMongo123@cluster0.tk16ay6.mongodb.net/anihubfilter?retryWrites=true&w=majority")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/90fc99d53f517bca4bf81-346bf43a3a17b0a425.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+cFO-dJGWlCMzNGRl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/anihubyt25')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'anihubyt25') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Priyanshu190')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>📂 ғɪʟᴇɴᴀᴍᴇ : {file_name}\n\n<b>⚙️ sɪᴢᴇ : {file_size}</b>")
