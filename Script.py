...
📛 <b>Name:</b> <a href=https://t.me/{}>{}</a>
👤 <b>Best Friend:</b> <a href='tg://settings'>You!</a>
...
☁️ <b>Server:</b> <a href='https://heroku.com'>Heroku</a>
🔄 <b>Version:</b> v2.7.1 [Stable]
...
<i>These commands are only for bot admins</i>

━━━━━━━━━━━━━━━━━━━━

<b>📊 Statistics & Logs:</b>
• /logs - <code>Get recent errors</code>
• /stats - <code>Get database statistics</code>

<b>👥 User Management:</b>
• /users - <code>Get list of users</code>
• /ban - <code>Ban a user</code>
• /unban - <code>Unban a user</code>

<b>💬 Chat Management:</b>
• /chats - <code>Get list of chats</code>
...
<b>🗃️ Files:</b>
• /delete - <code>Delete a specific file</code>
• /deletefiles - <code>Delete CamRip/PreDVD files</code>

<b>🔐 Verification:</b>
• /verify_panel - <code>Manage verification system</code>
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """<b>🔍 No exact match found for:</b> <code>{}</code>

<i>Did you mean one of these?</i> 👇"""

    I_CUDNT = """<b>❌ No Results Found</b>

<i>Sorry, no files were found for:</i> <code>{}</code>

━━━━━━━━━━━━━━━━━━━━

💡 <b>Tips to find your content:</b>

<b>📽 Movies:</b> <code>Avatar</code> or <code>Avatar 2022</code>
<b>📺 Series:</b> <code>Loki S01</code> or <code>Loki S01E04</code>

⚠️ <i>Avoid special characters like</i> <code>: ( ) ! , . /</code>

━━━━━━━━━━━━━━━━━━━━"""

    I_CUD_NT = """<b>🔎 No movie found for:</b> <code>{}</code>

<i>Please check your spelling on Google or IMDb and try again.</i>"""

    MVE_NT_FND = """<b>❌ Movie not found in database</b>"""
...
<b>⚙️ sɪᴢᴇ : {file_size}</b>""" 
    ...
    IMDB_TEMPLATE_TXT = """<b>🏷 Title: {title}
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this ANIHUBYT MOVIES BOT to your group

 Step 2: Add your this website and API

 Exp: /VPLINK.IN  AND USE THIS API :35591ad98834a002e1fe0b3b4acc6d84ef401782
